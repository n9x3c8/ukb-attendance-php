...
class Attendance extends Controller {
	...
	public function check_exit_in_room($student_id = null) {
		if($student_id !== null) {
	...
	public function info_details_attendance_student($student_id = null, $current_date = null) {
	...
	public function exist_in_attendance_student($student_id = null) {
		if($student_id !== null) {
			$attendance = $this->model('AttendanceModel');
	...
	public function state_attendance_student($student_id = null) {
		if( $student_id !== null) {
			$attendance = $this->model('AttendanceModel');
	...
	//Kiem tra xem gv da tat diem danh hay chua

	// public function check_stop_attendance($attendance_id_last)
	// {
	// 	if($_SERVER['REQUEST_METHOD'] == 'GET') {
	// 		$attendance = $this->model('AttendanceModel');
	// 		$data = $attendance->on_check_stop_attendance($attendance_id_last);
	// 		exit( json_encode($data) );
	// 	}
	// }
	...
	public function check_exist_in_take_leave($class_id = null, $subject_id = null, $current_date = null) {
		if($_SERVER['REQUEST_METHOD'] == 'GET') {
			$attendance = $this->model('AttendanceModel');
